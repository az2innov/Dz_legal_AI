// ========================================
// Script d'importation des PDFs dans MySQL
// Lit les fichiers PDF depuis un dossier et les insère dans la base de données
// ========================================
...
async function importPDFsToMySQL() {
    ...
    try {
        ...
        console.log('📦 Importation des PDFs dans la base de données...\n');
        ...
        for (const file of files) {
            try {
                ...
                if (result.affectedRows > 0) {
                    updated++;
                    console.log(`✅ ${id}.pdf importé (${(fileSize / 1024).toFixed(2)} KB) - ${updated}/${files.length}`);
                } else {
...
importPDFsToMySQL().then(() => {
    ...
    console.log('🚀 Vous pouvez maintenant tester l\'ouverture des documents sur le frontend.\n');
    process.exit(0);
}).catch((error) => {
