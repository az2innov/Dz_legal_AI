...
// Les 167 documents fournis par l'utilisateur
const documents = [
    ...
    { "id": "0000013", "title": "Communiqué de la réunion du Gouvernement-07-01-2026" },
    { "id": "0000014", "title": "Communiqué de la réunion du Gouvernement-23-12-2025" },
    { "id": "0000015", "title": "Communiqué de la réunion du Gouvernement-17-12-2025" },
    { "id": "0000016", "title": "Communiqué de la réunion du Gouvernement-09-12-2025" },
    ...
    { "id": "0000083", "title": "بيان اجتماع الحكومة 07-01-2026" },
    { "id": "0000084", "title": "بيان اجتماع الحكومة 23-12-2025" },
    { "id": "0000085", "title": "بيان اجتماع الحكومة 17-12-2025" },
    { "id": "0000086", "title": "بيان اجتماع الحكومة 09-12-2025" },
...
async function resetAndImport() {
    ...
    try {
        ...
        // 1. Supprimer tous les anciens documents
        console.log('\n🗑️  Suppression de tous les anciens documents...');
        ...
        // 2. Importer les 167 nouveaux documents
        console.log('📑 Importation des 167 nouveaux documents...\n');
        ...
        for (const doc of documents) {
            try {
                ...
                imported++;
                if (imported % 10 === 0) {
                    console.log(`   ${imported}/167 documents importés...`);
                }
            } catch (err) {
                errors++;
        ...
        console.log(`✅ Documents importés: ${imported}/167`);
        ...
        for (const stat of stats) {
            if (!groupedStats[stat.category]) {
                groupedStats[stat.category] = { fr: 0, ar: 0, total: 0 };
            }
            groupedStats[stat.category][stat.lang] = stat.count;
            groupedStats[stat.category].total += stat.count;
        }

        for (const [category, counts] of Object.entries(groupedStats)) {
            console.log(`${category.padEnd(20)} | FR: ${counts.fr.toString().padStart(3)} | AR: ${counts.ar.toString().padStart(3)} | Total: ${counts.total.toString().padStart(3)}`);
        }
        console.log('='.repeat(60));
